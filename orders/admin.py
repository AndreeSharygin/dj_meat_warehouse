...
#     model = OrderItem
#     extra = 0
#     readonly_fields = ('product_name', 'quantity', 'original_quantity', 'price', 'get_item_cost')
#     fields = ('product_name', 'quantity', 'original_quantity', 'price', 'get_item_cost')
#
#     @admin.display(description='Стоимость (₽)')
#     def get_item_cost(self, obj):
#         return f'{obj.item_cost} ₽'
...
# @admin.register(Order)
# class OrderAdmin(admin.ModelAdmin):
#     list_display = ('pk', 'client', 'shipment_date', 'status', 'get_adjusted', 'get_total', 'created_at')
...
#
#     fieldsets = (
#         ('Основное', {'fields': ('client', 'shipment_date', 'status')}),
#         ('Комментарии', {'fields': ('comment', 'manager_note')}),
#         ('Информация', {'fields': ('get_total_detail', 'get_total_no_discount', 'created_at')}),
#     )
#
